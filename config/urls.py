...
urlpatterns = [
    ...
    path('script/<int:script_id>/manage/', manage_script, name='manage_script'),
    ...
    path('episode/write/<int:episode_id>/', write_episode, name='write_episode'),
    path('episode/read/<int:episode_id>/', read_episode, name='read_episode'),
    path('ajax/add-episode/<int:script_id>/', add_episode_ajax, name='add_episode_ajax'),
    path('ajax/save-episode/<int:episode_id>/', save_episode_ajax, name='save_episode_ajax'),
    ...
    path('contests/manage/', manage_contests, name='manage_contests'),
    path('contests/<int:contest_id>/edit/', edit_contest, name='edit_contest'),
    path('contests/new/', create_contest, name='create_contest'),
    path('contests/<int:contest_id>/', contest_detail, name='contest_detail'),
    path('contests/<int:contest_id>/join/', join_contest, name='join_contest'),
    ...
    path('ajax/delete-book/<int:book_id>/', delete_book_ajax, name='delete_book_ajax'), # This is likely redundant but kept for safety
    path('ajax/delete-script/<int:script_id>/', delete_script, name='delete_script'),
    path('ajax/delete-poem/<int:poem_id>/', delete_poem, name='delete_poem'),
    ...
    path('ajax/confessions/<int:confession_id>/comments/', get_confession_comments_ajax, name='get_confession_comments_ajax'),
    ...
    path('ajax/delete-contest/<int:contest_id>/', ajax_delete_contest, name='ajax_delete_contest'),
    path('ajax/upload-cover/<str:item_type>/<int:item_id>/', ajax_upload_cover, name='ajax_upload_cover'),
    path('ajax/remove-cover/<str:item_type>/<int:item_id>/', ajax_remove_cover, name='ajax_remove_cover'),
    path('ajax/update-status/<str:item_type>/<int:item_id>/', ajax_update_status, name='ajax_update_status'),
